  ...
  return (
    <div className="p-12 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="">
          <p className="text-5xl italic font-semibold tracking-wider text-center mt-10 text-red-200">
            Featured Webinars
          </p>
          <p className="text-center text-2xl tracking-wide mt-5">
            Enhaned Tech Journey
          </p>
        </div>
      ...
      <CardDescription>
        ...
        <div className="mt-10 text-center">
            <Button borderRadius="1.25rem" className="text-lg">
                View All Webinars
            </Button>
        </div>
      </div>
...
const Skeleton = () => {
    ...
    useEffect(() => {
      // @ts-expect-error: The animate function requires the sequence parameter to be a specific type 
      // that TypeScript doesn't infer correctly, so we're bypassing the type check here.
      animate(sequence, {
        repeat: Infinity,
        repeatDelay: 1,
      });
  ...
  export const CardTitle = ({
    ...
    return (
      <h3
        className={cn(
          "text-2xl font-semibold text-gray-800 dark:text-white py-2",
          className
        )}
      >
        {children}
